...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/YourDemandZone')
            ],
            [
                InlineKeyboardButton('⚡ CONTACT ⚡', url=f"https://t.me/Mr_SpidyBot"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ CONTACT ⚡', url='https://t.me/Mr_SpidyBot'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/YouerDemandZone')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
