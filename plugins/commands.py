...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/+m73G5tXj4esxODJl')
            ],
            [
                InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url=f"https://youtube.com/channel/UCZOyRpcCWDdnsdAzH0L8egg"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url='https://youtube.com/channel/UCZOyRpcCWDdnsdAzH0L8egg'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/+m73G5tXj4esxODJl')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://youtube.com/channel/UCZOyRpcCWDdnsdAzH0L8egg') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
