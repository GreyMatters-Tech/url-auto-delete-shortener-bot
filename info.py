...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "ɴᴀᴍᴇ: <code><strong>{file_name}</strong></code> \n\nJᴏɪɴ ɴᴏᴡ: [Cinema Dudes](https://t.me/cinemadudes1)</b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "ɴᴀᴍᴇ: <code><strong>{file_name}</strong></code> \n\nᴊᴏɪɴ ɴᴏᴡ: [Cinema Dudes](https://t.me/cinemadudes1)</b>")
